...
const CustomModal = ({ open, onClose, user, handleBan, handleDelete }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogActions sx={{ px: 3, py: 2 }}>
        <MDButton onClick={handleBanClick} color="warning" variant="outlined">
          Ban
        </MDButton>
        <MDButton onClick={handleDeleteClick} color="error" variant="outlined">
          Delete
        </MDButton>
      </DialogActions>
    </Dialog>
